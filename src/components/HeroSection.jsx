...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-screen flex items-center justify-center m-0 p-0 overflow-hidden bg-black"
    >
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              'url("https://images.unsplash.com/photo-1651340048650-9bb75627f3de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxneW0lMjB3b3Jrb3V0JTIwaW50ZXJpb3IlMjBkYXJrfGVufDF8fHx8MTc3Mjg3MjcyMXww&ixlib=rb-4.1.0&q=80&w=1080")',
          }}
        />
        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <span className="text-accent text-xs font-bold tracking-widest uppercase">
              Premium Fitness Experience in Kalkaji, New Delhi
            </span>
          </motion.div>
          ...
          >
            Push your limits and redefine your strength at LIV FIT GYM,
            Kalkaji&apos;s premier fitness destination with top-tier equipment
            and expert coaching.
          </motion.p>
          ...
          >
            ...
            <button className="relative bg-accent text-black px-6 py-3.5 sm:px-10 sm:py-5 md:px-14 md:py-6 rounded-full font-black text-sm sm:text-lg md:text-xl uppercase tracking-wide sm:tracking-wider whitespace-nowrap hover:bg-white transition-colors duration-300">
