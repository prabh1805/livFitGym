...
const StatCounter = ({ end, label, suffix = '+' }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <span className="text-3xl md:text-5xl font-black text-[#ffcc00] mb-2 font-mono">
        {count}{suffix}
      </span>
      ...
      >
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mb-6 px-4 py-1.5 rounded-full border border-[#ffcc00]/30 bg-[#ffcc00]/10 backdrop-blur-sm"
          >
            <span className="text-[#ffcc00] text-xs font-bold tracking-widest uppercase">Premium Fitness Experience</span>
          </motion.div>
          ...
          <div className="overflow-hidden mb-8">
            <motion.h1 
              ...
              className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-[#ffcc00] uppercase tracking-tighter leading-none drop-shadow-[0_0_25px_rgba(255,204,0,0.5)]"
            >
              Stay Strong.
            </motion.h1>
          </div>
          ...
          >
            {/* Glow Behind Button */}
            <div className="absolute -inset-1 bg-[#ffcc00] rounded-full blur opacity-40 group-hover:opacity-100 transition duration-500"></div>
            <button 
              className="relative bg-[#ffcc00] text-black px-10 py-5 sm:px-14 sm:py-6 rounded-full font-black text-lg sm:text-xl uppercase tracking-wider hover:bg-white transition-colors duration-300"
            >
