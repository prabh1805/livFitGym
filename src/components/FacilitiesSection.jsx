...
const FacilityIcon = ({ name }) => {
  ...
  return (
    <div className="w-14 h-14 bg-neutral-900 rounded-2xl flex items-center justify-center mb-6 border border-neutral-800 group-hover:border-[#ffcc00] group-hover:shadow-[0_0_15px_rgba(255,204,0,0.4)] transition-all duration-300">
      <svg className="w-7 h-7 text-[#ffcc00]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        {getIconSvg()}
      </svg>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight mb-4">
            World-Class <span className="text-[#ffcc00]">Facilities</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {facilitiesData.map((facility, index) => (
            <motion.div 
              ...
              className="bg-[#121212] border border-neutral-800 rounded-3xl p-8 hover:border-[#ffcc00]/50 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(255,204,0,0.1)] group cursor-default h-full"
            >
