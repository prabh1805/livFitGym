        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-[#121212] border border-neutral-800 rounded-2xl p-8 hover:border-accent/30 transition-all duration-300 flex flex-col items-center text-center">
            <div className="bg-accent/10 p-5 rounded-full mb-6 relative group">
              <svg className="w-10 h-10 text-accent group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="tel:+919876543210" className="text-2xl font-semibold text-accent hover:text-white transition-colors duration-300">
              +91 9876543210
            </a>
          </div>
