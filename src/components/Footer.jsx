        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-400 font-light mb-8 leading-relaxed">
              Premium fitness facility dedicated to helping you unlock your true
              potential and build a stronger, healthier lifestyle.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                title="Instagram"
                className="w-12 h-12 rounded-full bg-neutral-900 flex items-center justify-center text-gray-400 hover:text-accent hover:bg-neutral-800 transition-all duration-300"
              >
                <svg
                  className="w-7 h-7"
                  fill="none"
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 text-accent shrink-0 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <li className="flex items-start text-gray-400 leading-relaxed">
                ...
                <span>
                  59/2 Guru Ravidas Marg,
                  <br />
                  Opp HDFC Bank, Kalkaji,
                  <br />
                  New Delhi – 110019
                </span>
              </li>
